    ...
    <div className="iphone-mockup">
      <div className="iphone-frame">
        <div className="iphone-screen">
          ...
          {/* Status Bar */}
          <div className="flex justify-between items-center px-7 pt-4 pb-2 text-sm font-semibold text-[var(--jm-text)] relative z-20">
            <span className="text-[15px] font-semibold">9:41</span>
            <div className="flex items-center gap-1.5 text-[var(--jm-text)]">
              <svg width="12" height="10" viewBox="0 0 17 12" fill="currentColor">
